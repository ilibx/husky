...
type Service interface {
	...
	Ask(ctx context.Context, question string, model string, deepThinking bool, images []string, tool string) (*model.AnswerResponse, error)
	AskStream(ctx context.Context, question string, model string, deepThinking bool, images []string, tool string, onChunk func(string) error) (*model.AnswerResponse, error)
